...
"""
    ...
    Log:
        ...
        2024-07-07 0.3.1 Me2sY
            新增 IndicatorAim, 用于视角控制

        2024-06-30 0.3.0 Me2sY
            重构，改用 Locator 统一控制Item Draw 位置

        2024-06-22 0.2.0 Me2sY
            重构，改用控件保留相应属性

        2024-06-21 0.1.2 Me2sY
            优化结构

        2024-06-20 0.1.1 Me2sY
            完成类编写

        2024-06-18 0.1.0 Me2sY
            创建，从 TPEditor 中抽离
